...
VoidCuriosity es el proyecto que están realizando un grupo de alumnos de 1º de Bachillerato del IES Vicente Aleixandre para la asignatura de Tecnología Industrial I y TIC I, basado en el proyecto abierto creado por @felixstdp, el cual se puede encontrar en [bricolabs](https://bricolabs.cc/wiki/proyectos/curiosity_btl), y en la versión creada por @javacasm
